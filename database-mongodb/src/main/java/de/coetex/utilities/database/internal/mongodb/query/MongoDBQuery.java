...
import de.coetex.utilities.database.action.DatabaseQuery;
import de.coetex.utilities.database.action.ExecutedQuery;
import de.coetex.utilities.database.exceptions.DatabaseException;
import de.coetex.utilities.database.internal.abstraction.DefaultExecutedQuery;
...
import de.coetex.utilities.database.internal.mongodb.where.ObjectWhere;
import de.coetex.utilities.database.internal.mongodb.where.StringIgnoreCaseWhere;
...
public class MongoDBQuery implements DatabaseQuery {
	...
	private ExecutedQuery createExecutedQuery(@Nonnull List<Document> documents) {
		List<de.coetex.utilities.common.config.Document> results = new ArrayList<>(documents.size());
